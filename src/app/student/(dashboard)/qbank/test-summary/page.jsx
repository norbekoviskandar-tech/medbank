...
export default function TestSummaryPage() {
  ...
  const router = useRouter();
   ...
   const handleReview = () => {
    const reviewDurations = (testResult?.timeSpent && typeof testResult.timeSpent === 'object')
      ? testResult.timeSpent
      : (Array.isArray(testResult?.attemptAnswers)
        ? testResult.attemptAnswers.reduce((acc, a) => {
            acc[String(a.questionId)] = Number(a.timeSpentSec || 0);
            return acc;
          }, {})
        : {});
    ...
    localStorage.setItem("medbank_current_test", JSON.stringify({
      ...testResult,
       ...
       questionDurations: reviewDurations,
